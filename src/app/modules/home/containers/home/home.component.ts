...
export class HomeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // @see https://codepen.io/72lions/pen/nzdpWz
    this.CONTAINER = <any>this.document.querySelector('section');
    this.SCREEN_WIDTH = this.CONTAINER.offsetWidth;
    this.SCREEN_HEIGHT = this.CONTAINER.offsetHeight;
    this.CANVAS = <any>this.document.querySelector('.canvas-background');
  ...
  loop(): void {
    const theme = <any>this.document.documentElement.getAttribute('data-bs-theme');
